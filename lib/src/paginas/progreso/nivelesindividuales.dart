                ...
                Container(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image(
                        ...
                        image: NetworkImage(
                            'https://resizer.iproimg.com/unsafe/880x/https://assets.iproup.com/assets/jpg/2019/09/6063.jpg?5.6.1.6')),
                  ),
                ),
                Column(
                  children: <Widget>[
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                              ...
                              child: Image(
                                  fit: BoxFit.contain,
                                  image: NetworkImage(
                                      'https://infonegocios.biz/uploads/Mc-InfoNegocios-1.jpg'))),
                        ),
                        Padding(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            title: RichText(
              text:
                  TextSpan(style: Theme.of(context).textTheme.title, children: [
                TextSpan(
                  text: 'Progreso',
