...
//Tarjetas que indican los premios para cada nivel obtenido
  ...
  Widget _circulogeneraprogreso(){
    ...
    return Container(
      ...
      onTap: ()=> Navigator.pushReplacementNamed(context, 'progresoporrubro' ),
      child: Column(
        children:<Widget>[
...
//Se promedia los numeros de las diferentes categorias          
          center: Text('5\n/20',style: TextStyle(fontSize: 40.0, color: Colors.white),
          ),
        ),
        Container(
          ...
          child: Column(
            children: <Widget>[
              Text('Nivel 3', 
              style: Theme.of(context).textTheme.title, textScaleFactor: 1.5,
              ),  
            ],
          ),
        )
...
//Beneficios nivel 1                              
                child: Text(' - Voucher de 100 para usar en la proxima compra en productos seleccionados \n - Acceso a beneficios exclusivos \n - Descuentos permantenes en tiendas exclusivas',
                  style: TextStyle(fontSize: 15.0),textAlign: TextAlign.start
                  ),
              ),
            ),
            ]
